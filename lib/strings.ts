export const strings = {
  en: {
    ...
    pricingSub:
      "Jump to the live download section for the latest desktop builds on Mac, Windows, and Linux.",
    ...
    downloadCardLabel: "Latest release",
    downloadCardTitle: "Desktop downloads are live.",
    downloadCardBody:
      "Use the direct download section below to install LiveAssist AI on Mac, Windows, or Linux.",
    downloadCardStatusLabel: "Availability",
    downloadCardStatus: "Mac, Windows, Linux",
    downloadCardNote: "Apple Silicon uses the DMG build. Windows uses the installer. Linux uses the AppImage.",
  ...
  ru: {
    ...
    pricingSub:
      "Перейдите к блоку скачивания ниже, чтобы установить актуальную desktop-версию для Mac, Windows или Linux.",
    ...
    downloadCta: "Перейти к скачиванию",
    downloadCardLabel: "Последний релиз",
    downloadCardTitle: "Desktop-сборки уже доступны.",
    downloadCardBody:
      "Используйте блок скачивания ниже, чтобы установить LiveAssist AI на Mac, Windows или Linux.",
    downloadCardStatusLabel: "Доступность",
    downloadCardStatus: "Mac, Windows, Linux",
    downloadCardNote: "Для Apple Silicon используется DMG, для Windows - установщик, для Linux - AppImage.",
